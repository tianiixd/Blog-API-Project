...
const app = express();
const port = Number(process.env.portIndex);
...
app.patch("/posts/:id", (req, res) => {
  ...
  if (!existingPost || existingPostIndex === -1)
  ...
  const formattedAuthor = author ? author : existingPost?.author;
  ...
  posts[existingPostIndex] = updatePost;
  res.json(updatePost);
});
